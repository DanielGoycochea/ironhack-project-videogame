...
function isTouching (a,b){
  ...
  function drawScore(){
    ...
    ctx.fillStyle = "white";
    ctx.fillText ("MUERTOS: "+score,860,50);
  }

  function drawlive(){
    ctx.font = "36px Orbitron";
    ctx.fillStyle = "white";
    ctx.fillText ("VIDAS: "+life,50,50);
  }
  ...
  if (life <= 0){
      ...
      ctx.font = "bold 40px Orbitron";
	  	ctx.fillStyle = "white";
		  ctx.fillText("GAME OVER!", canvas.height/2+150, 300);
    }
  }
